...
async function getShowData() {
  ...
  //   const showDetail = await axios.get(
  //     `http://13.115.196.55/api/v1/show?id=${id}`
  //   );
  //   console.log(showDetail.data);
  //   document.getElementById(
  //     "image"
  //   ).innerHTML = `<img src="http://13.115.196.55/uploads/${showDetail.data.show[0].image}" alt="seatChart" >`;
  //   document.getElementById("bgimage").innerHTML = `<div
  //   class="bg-cover blur"
  //   style="background-image: url('http://13.115.196.55/uploads/${showDetail.data.show[0].image}'); height: 430px"
  // ></div>`;
  ...
  // });
  // seatChart.innerHTML = `<img src="http://13.115.196.55/uploads/${showDetail.data.show[0].seat_chart}" alt="seatChart" class="chart-size ">`;
  // console.log(id);
  // document.getElementById(
  //   "seatForm"
